...
int main() {
    ...
    scene.spheres.push_back(Sphere{ Vec3f(2048, 500, 500), 400, GRY_Color{50,50,255,255} });
    scene.spheres.push_back(Sphere{ Vec3f(2048, 0, 0), 150, GRY_Color{255,64,64,255}  });
    // scene.spheres.push_back(Sphere{ Vec3f(1500, 500, 500), 50, GRY_Color{128,128,128,255}  });
    ...
    scene.spheres.push_back(Sphere{ Vec3f(1000, 225, -250), 100, GRY_Color{26,26,128,255} });
    scene.spheres.push_back(Sphere{ Vec3f(1000, -400, 300), 250, GRY_Color{100,64,128,255} });
