...
int main() {
    ...
    scene.planes.push_back(Plane{ Vec3f(0,-1,0), 1000, GRY_Material{GRY_Color{1.0f,1.0f,.0f,1.0f}} });
    scene.planes.push_back(Plane{ Vec3f(0,1,0), 2500, GRY_Material{GRY_Color{1.0f,.25f,.25f,1.0f}} });
