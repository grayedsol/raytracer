...
int main() {
    ...
    scene.spheres.push_back(Sphere{ Vec3f(2048, 500, 500), 400, GRY_Material{GRY_Color{.0f,.0f,1.0f,1.0f}} });
    ...
    scene.lights.push_back(Light{ Vec3f(500, 750, -750), 0.75f, GRY_Color{0.1f,0.3f,1.0f}});
    scene.lights.push_back(Light{ Vec3f(500, 0, 2000), 0.75f, GRY_Color{1.0f,0.3f,1.0f} });
